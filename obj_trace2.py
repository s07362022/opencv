...
def getContours(img):
    ...
    for cnt in contours:
        ...
        if area>500:
            cv2.drawContours(imgResult, cnt, -1, (255, 255, 0), 3) #輪廓邊緣
            ...
            #cv2.rectangle(imgResult,(x,y),(x+w,y+h),(255,255,0),5) #畫出矩形
    return x+w//2,y+h//2
...
while True:
    ...
    cv2.putText(imgResult, label, (100, 100 -5), font, 7, [0,255,20], 5)
    if len(newPoints)!=0:
